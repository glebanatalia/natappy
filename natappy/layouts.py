...
def main(rep, blogger, link):
    if link == '':
        ...
        social_media_position = 245 - \
            stringWidth2('Social media', font='Lato-Reg', size=16, charspace=0) / 2
        rep.drawString(social_media_position, 480, 'Social media')
        rep.setFont("Lato-Reg", 16)
        blogger_position = 255 - stringWidth2(blogger.upper(),
                                              font='Lato-Reg', size=16, charspace=0) / 2
        ...
        rep.setFillColor('black')
        blogger_position = 630 - stringWidth2(blogger.upper(),
                                              font='Lato-Reg', size=16, charspace=0) / 2
